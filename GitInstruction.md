...
* для связи локального проекта с удаленным репозиторием существоует команда *git remote origin <ссылка с github>*

* для отпраки проекта команда *git push*

* для загрузки проекта команда *git pull*
